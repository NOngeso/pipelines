...
/data2/k821209/programs/genometools-1.5.1/bin/gt -j 2 ltrdigest -pptlen 10 30 -pbsoffset 0 3 -trnas Athal-tRNAs.fa -hmms ./hmm/*.hmm -outfileprefix ${1} ${1}.sort.gff3 ${1} > ${1}.ltrdigest_GyDB.gff3
